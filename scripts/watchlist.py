...
WATCHLIST = {
    ...
    "7780": ("otc", "大研生醫*", "上櫃"),  # 🆕 保健食品王，庫藏區下限 12.75 保護，分 3 批進場 (B 計畫)
}
...
BUY_ZONES = {
    ...
    # 2241 已於 2026-08-09 週報決議從主清單移除（8/5 Q2 財報 H1 虧損 4,366 萬、Q2 EPS -0.27、毛利率 7.67%；8/7 -6.98% 跌破停損）
...
SCAN_STATUS = {
    ...
    # === 2026-08-09 週報新增 ===
    "2241": "ARCHIVED_REMOVED",  # 艾姆勒 - 8/5 Q2 財報 H1 虧損 4,366 萬、Q2 EPS -0.27、毛利率 7.67%；8/7 -6.98% 跌破停損；紀律出清，從主清單移除
    # === 持續 WATCH ===
    "4123": "WATCH",       # 晟德
    # === 繼續 EVALUATING ===
    "4147": "EVALUATING",  # 中裕
